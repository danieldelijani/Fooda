var urlSignature = (function (exports, Base64, HmacSHA1) {
	...
	var global$D = global$E; // eslint-disable-next-line es/no-object-defineproperty -- safe
	...
	var uncurryThis$m = NATIVE_BIND$3 && bind$4.bind(call$f, call$f);
	...
	var Object$5 = global$A.Object; // `ToObject` abstract operation
	...
	var fails$i = fails$k; // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
	...
	var fails$h = fails$k; // Detect IE8's incomplete defineProperty implementation
	...
	var fails$f = fails$k; // V8 ~ Chrome 36-
	...
	var TypeError$e = global$v.TypeError; // `Assert: Type(argument) is Object`
	...
	var TypeError$d = global$s.TypeError; // `Assert: IsCallable(argument) is true`
	...
	var TypeError$c = global$r.TypeError; // `OrdinaryToPrimitive` abstract operation
	...
	var TypeError$a = global$p.TypeError; // eslint-disable-next-line es/no-object-defineproperty -- safe
	...
	*/
	...
	var fails$b = fails$k;
	var global$h = global$E; // babel-minify and Closure Compiler transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError
	...
	var fails$a = fails$k;
	var global$g = global$E; // babel-minify and Closure Compiler transpiles RegExp('.', 's') -> /./s and it causes SyntaxError
	...
	var fails$9 = fails$k;
	var global$f = global$E; // babel-minify and Closure Compiler transpiles RegExp('(?<a>b)', 'g') -> /(?<a>b)/g and it causes SyntaxError
