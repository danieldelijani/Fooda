    ...
    if (!fontsLoaded) {
        ...
        return (
            <View style={styles.container}>
                ...
                {groceryListsDisplay.length ? null : <View style={{height:'70%', justifyContent:'center'}}>
                    <Image source={fruits} style={{ alignSelf: 'center', height: 350, width: 350, resizeMode: 'contain' }} />
                </View>}
                <FlatList
